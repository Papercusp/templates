# papercusp-webapp — check contracts
...
ROOT app scope, and the **full additive union-of-checks**
(`templateId:checkId`) survives. That union IS the app's definition of done.
...
closure's aspect suites: `boot-e2e` (`../../papercusp-web-host/checks/`)
