# papercusp-data-sync — check contracts
...
```jsonc
{
  "components": {
    ...
    // resumable-download at the `large-assets` decision point, omit it here.
    "packages": ["@papercusp/sync", "@papercusp/sse", "@papercusp/projection-index", "@papercusp/debounce-coalesce"],
